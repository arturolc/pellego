...
public class RSVP extends Sound {
    ...
    public static final String TTS_INIT = com.github.axet.androidlibrary.sound.TTS.class.getCanonicalName() + ".TTS_INIT";
    ...
    public void playSpeech(final com.gitlab.capstone.pellego.app.TTS.Speak speak, final Runnable done) {
        dones.add(done);
            ...
            tts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                ...
                public void onRangeStart(final String utteranceId, final int start, final int end, final int frame) { // API26
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.RSVP.this.onRangeStart(utteranceId, start, end, frame);
                        }
                    });
                }
                ...
                public void onDone(final String utteranceId) {
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.RSVP.this.onDone(utteranceId, clear);
                        }
                    });
                }
                ...
                public void onError(final String utteranceId) {
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.RSVP.this.onError(utteranceId, clear);
                        }
                    });
                }
            });
    ...
    public boolean playSpeech(com.gitlab.capstone.pellego.app.TTS.Speak speak) {
        if (onInit != null)
            return false;
