...
public class ClumpReadingFragment extends BaseFragment {
    ...
    private static ClumpReadingFragment.AsyncUpdateReaderText asyncUpdateReaderText;
    ...
    private void showSubmodulePopupDialog() {
        ...
        dialogButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.dismiss();
                asyncUpdateReaderText = new ClumpReadingFragment.AsyncUpdateReaderText(); // start thread on ok
        ...
        protected void onPostExecute(Integer result) {
            try {
                if (PlayerWidget.playing) {
                    ...
                    mtext.setText(content);
                    idx = 0;
                    asyncUpdateReaderText = new ClumpReadingFragment.AsyncUpdateReaderText();
                    asyncUpdateReaderText.execute(PlayerWidget.wpm);
                } else {
                    try {
                        showQuizPopupDialog();
