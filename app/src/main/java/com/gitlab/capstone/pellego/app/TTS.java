            ...
            tts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
                ...
                public void onRangeStart(final String utteranceId, final int start, final int end, final int frame) { // API26
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.TTS.this.onRangeStart(utteranceId, start, end, frame);
                        }
                    });
                }
                ...
                public void onDone(final String utteranceId) {
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.TTS.this.onDone(utteranceId, clear);
                        }
                    });
                }
                ...
                public void onError(final String utteranceId) {
                    handler.post(new Runnable() {
                        @Override
                        public void run() {
                            com.gitlab.capstone.pellego.app.TTS.this.onError(utteranceId, clear);
                        }
                    });
                }
            });
