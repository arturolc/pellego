...
public class LibraryFragment2 extends Fragment implements ReaderActivity.SearchListener {
    public static final String TAG = LibraryFragment2.class.getSimpleName();
    ...
    public class LibraryAdapter extends BooksAdapter {
        ...
        public LibraryAdapter(FragmentHolder holder) {
            super(LibraryFragment2.this.getContext(), holder);
        }
    ...
    public static LibraryFragment2 newInstance() {
        LibraryFragment2 fragment = new LibraryFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_library_2, container, false);
