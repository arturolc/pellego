...
public class FBFooterView extends LinearLayout {
    ...
    public void create(FBReaderView fb) {
        ...
        LayoutParams lpText = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, footer.getHeight());
        ...
        if (footerOptions.ShowBattery.getValue()) {
            ...
            LayoutParams lpImage = new LayoutParams(footer.getHeight(), footer.getHeight());
