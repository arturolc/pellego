...
import com.example.pellego.fragments.LibraryFragment2;
import com.example.pellego.fragments.ReaderFragment;
...
public class ReaderActivity extends FullscreenActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    boolean isRunning;
    String lastSearch;
    LibraryFragment2 libraryFragment2 = LibraryFragment2.newInstance();
        ...
        Thread thread = new Thread("load book") {
            ...
            public void run() {
                ...
                try {
                    ...
                    ErrorDialog.Post(ReaderActivity.this, e);
                } finally {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
        ...
        if (uu.size() > 1) {
            ...
            final Runnable done = new Runnable() {
                ...
                public void run() {
                    ...
                    for (Uri u : uu) {
                        try {
                            Storage.RecentInfo info = new Storage.RecentInfo(ReaderActivity.this, u);
                            book.info.merge(info);
                        } catch (Exception e) {
                            Log.d(TAG, "unable to merge info", e);
                        }
                        Storage.delete(ReaderActivity.this, u);
                    }
    ...
    public void openLibrary() {
        ...
        openFragment(libraryFragment2, LibraryFragment2.TAG).commit();
    ...
    public FragmentTransaction openFragment(Fragment f, String tag) {
        FragmentManager fm = getSupportFragmentManager();
        return fm.beginTransaction().replace(R.id.reader_content, f, tag);
    }
