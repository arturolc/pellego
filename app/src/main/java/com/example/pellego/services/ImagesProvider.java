package com.example.pellego.services;
...
public class ImagesProvider extends StorageProvider {
    public static String TAG = com.example.pellego.services.ImagesProvider.class.getSimpleName();

    public static final String EXT = "png";

    public static com.example.pellego.services.ImagesProvider getProvider() {
        return (com.example.pellego.services.ImagesProvider) infos.get(com.example.pellego.services.ImagesProvider.class);
    }
